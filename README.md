...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2FDangerprobots%2Fdangercat&envs=API_HASH%2CAPI_ID%2CHANDLER%CABUSE%CDANGERCAT_SESSION%CBOT_TOKEN)
```
/ping <input>    
```
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/dangerbots/mentiontg)
